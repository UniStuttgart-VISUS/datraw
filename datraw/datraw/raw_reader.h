...
#if !defined(_DATRAW_RAW_READER_H)
#define _DATRAW_RAW_READER_H
#pragma once
...
public:
    ...
    /// </summary>
    inline raw_reader(void) noexcept : curTimeStep(0) { }
    ...
    /// </summary>
    /// <param name="info">The content of a dat file.</param>
    inline raw_reader(info_type&& info) noexcept
    ...
    inline const info_type& info(void) const noexcept {
        return this->datInfo;
    }
    ...
    inline time_step_type current(void) const noexcept {
...
#endif /* !defined(_DATRAW_RAW_READER_H) */
