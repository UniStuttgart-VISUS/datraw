...
#if !defined(_DATRAW_CONVERT_H)
#define _DATRAW_CONVERT_H
#pragma once
...
inline void swap_byte_order(uint64 *data, const std::size_t cnt);
...
/// <param name="cnt">The number of numbers designated by
/// <paramref name="data" />.</param>
inline void swap_byte_order(uint32 *data, const std::size_t cnt);
...
/// <param name="cnt">The number of numbers designated by
/// <paramref name="data" />.</param>
inline void swap_byte_order(uint16 *data, const std::size_t cnt);
...
/// <param name="cnt">The number of numbers designated by
/// <paramref name="data" />.</param>
inline void swap_byte_order(const std::size_t width, void *data,
...
#endif /* !defined(_DATRAW_CONVERT_H) */
