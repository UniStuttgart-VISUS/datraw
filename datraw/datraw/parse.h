...
#if !defined(_DATRAW_PARSE_H)
#define _DATRAW_PARSE_H
#pragma once
...
/// </summary>
/// <tparam name="S">The type of string being processed.</tparam>
template<class S> struct parser<S, endianness> {
    typedef typename S::value_type char_type;
    typedef S string_type;
    typedef endianness value_type;
...
/// </summary>
/// <tparam name="S">The type of string being processed.</tparam>
template<class S> struct parser<S, grid_type> {
    typedef typename S::value_type char_type;
    typedef S string_type;
    typedef grid_type value_type;
...
/// </summary>
/// <tparam name="S">The type of string being processed.</tparam>
template<class S> struct parser<S, scalar_type> {
    typedef typename S::value_type char_type;
    typedef S string_type;
...
/// <summary>
/// Tries parsing a value of the given type <tparamref name="T" /> from the
/// given string <paramref name="str" />.
/// <summary>
/// <tparam name="T">The type to be parsed from a string.</tparam>
/// <tparam name="S">The type of string being processed.</tparam>
...
/// not represent a valid value of type <tparamref name="T" />
/// </exception>
template<variant_type T, class S>
inline detail::variant_t<T> parse(const S& str) {
    return parse<detail::variant_t<T>>(str);
}
