...
#if !defined(_DATRAW_GRID_TYPE_H)
#define _DATRAW_GRID_TYPE_H
#pragma once
...
enum class grid_type {
    ...
    /// <summary>
    /// A rectilinear grid for which the distances between the subdivisions is
    /// explicitly given.
    /// </summary>
    rectilinear,
    ...
    /// implementation there seems to be incomplete such that it is not clear
    /// how the format is actually defined.
    /// </remarks>
    tetrahedral
};
...
#endif /* !defined(_DATRAW_GRID_TYPE_H) */
